		...
		<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">Top Phase Contact Page</a>
				</div>
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						<li>
							...
							<a href="../"><strong>to homepage</strong></a>
						</li>
					</ul>
				</div>
			</div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Top Phase Global</strong></h1>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-bottom">
			                    <form method="POST">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="name" placeholder="Name..." class="contact-name form-control" id="contact-name" required>
			                        </div>
			                    	<div class="form-group">
									...
									<div class="form-group">
			                        	...
			                        	<input type="number" name="phone" placeholder="Phone number..." class="form-control" id="contact-phone" required>
			                        </div>
			                        <div class="form-group">
